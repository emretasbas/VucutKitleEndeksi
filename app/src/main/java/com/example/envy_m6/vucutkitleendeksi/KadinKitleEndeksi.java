 ...
 */
public class KadinKitleEndeksi extends Activity {
    EditText et1, et2;
    Button btn1, btn2;
    TextView tv, tvSonuc;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.vke_kadin);

        et1 = (EditText)findViewById(R.id.editVKEK1);
        et2 = (EditText)findViewById(R.id.editVKEK2);
        btn1 = (Button)findViewById(R.id.btnVKEK);
        btn2 = (Button)findViewById(R.id.btnIKK);
        tv = (TextView)findViewById(R.id.textVKEK);
        tvSonuc = (TextView)findViewById(R.id.textSonucK);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), KadinIdealKilo.class);
                startActivity(i);
            }
        });
